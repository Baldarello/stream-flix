 ...
 */
const TvEmptyState = ({ message, ctaLabel, onCtaClick }) => {
    ...
    return (
        <div id="tv-empty-state" className="tv-empty-state" role="status" aria-live="polite">
            <EmptyIcon />

            <p className="empty-message">{message || t('tv.empty', 'Nessun contenuto disponibile')}</p>
