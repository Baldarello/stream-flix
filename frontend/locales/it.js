export const it = {
    ...
    linkEpisodesModal: {
        ...
        add: {
            ...
            save: 'Aggiungi Link',
            patternInfo:
                "Usa [@EP] come segnaposto per il numero dell'episodio. Sarà sostituito per ogni episodio della stagione.",
            ...
            listInfo:
                'Incolla un elenco di link, uno per riga. Il numero di link deve corrispondere al numero di episodi ({count}).',
            listLinks: 'Lista di link',
            jsonInfo:
                'Incolla un array JSON di stringhe (link) o di oggetti (es. {"url": "...", "label": "...", "language": "ENG", "type": "dub"}).',
    ...
    syncConflict: {
        ...
        overviewInfo:
            'Sono state trovate differenze tra i dati locali e quelli nel cloud. Clicca "Continua" per scegliere cosa prendere da dove per ogni show, oppure usa una delle azioni rapide qui sotto.',
    ...
    libraryManagement: {
        ...
        preferredSources: {
            ...
            editInfo:
                "Inserisci l'URL completo della fonte. L'origine (schema + host) verrà salvata come preferita per questo show.",
    ...
    notifications: {
        ...
        episodeNumberRangeMismatch:
            "L'intervallo di episodi ({epRange}) e l'intervallo di numerazione ({numRange}) devono avere la stessa lunghezza.",
