export const en = {
    ...
    linkEpisodesModal: {
        ...
        add: {
            ...
            jsonInfo:
                'Paste a JSON array of strings (links) or objects (e.g., {"url": "...", "label": "...", "language": "ENG", "type": "dub"}).',
    ...
    syncConflict: {
        title: 'Sync Conflict',
        overviewInfo:
            'Differences were found between the local data and the cloud. Click "Continue" to pick what to take from where for each show, or use one of the quick actions below.',
    ...
    libraryManagement: {
        ...
        preferredSources: {
            ...
            editInfo:
                'Enter the full source URL. The origin (scheme + host) will be saved as the preferred source for this show.',
            editUrl: 'Source URL',
    ...
    notifications: {
        ...
        episodeNumberRangeMismatch:
            'The episode range ({epRange}) and the numbering range ({numRange}) must have the same length.',
