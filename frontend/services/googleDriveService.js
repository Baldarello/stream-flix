...
// DriveFile type - use {id, name} objects
...
export const findLatestBackupFile = async (accessToken) => {
...
export const listBackupFiles = async (accessToken) => {
    const params = new URLSearchParams({
        q: `name contains '${BACKUP_FILE_PREFIX}' and trashed=false`,
        spaces: FOLDER,
        fields: 'files(id, name, createdTime)',
...
export const deleteOldBackups = async (accessToken) => {
...
export const readBackupFile = async (accessToken, fileId) => {
