...
const GoogleDriveSyncConflictModal = observer(
    ({ open, onClose, conflictData, onMerge, onOverwriteLocal, onOverwriteRemote, onCancel, isProcessing = false }) => {
        const { t } = useTranslations();
        const { syncConflictStep, syncConflictChoices, initializeSyncConflictChoices, setSyncConflictStep, resetSyncConflict } =
            mediaStore;
