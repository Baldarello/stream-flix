...
const LibraryManagementView = observer(() => {
    ...
    const handleClearLinksForShow = async (showId) => {
    ...
    const handleRemoveFromMyList = (itemId) => {
    ...
    const handleConfirmDelete = async () => {
        ...
        if (deleteConfirm.type === 'myList') {
            mediaStore.toggleMyList({id: deleteConfirm.id});
    ...
    const getShowNameForEpisode = (episodeId) => {
